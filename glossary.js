...
{target:`バンドル`, content:`単体でも提供可能な製品やサービスを、複数組み合わせてセットで販売したり、別の製品やサービスに付属して販売、提供すること。`},
{target:`npm（node package manager）`, content:`Node.jsのパッケージマネージャー。コードをホスティングするレジストリとそれを操作するCLIからなる。`},
